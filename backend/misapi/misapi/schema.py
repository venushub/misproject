...
class Mutation(miscore.activity.schema.Mutation, miscore.profile.schema.Mutation ,miscore.project.schema.Mutation , miscore.activitytypeidentifier.schema.Mutation , users.schema.Mutation, miscore.activitytype.schema.Mutation, graphene.ObjectType):
