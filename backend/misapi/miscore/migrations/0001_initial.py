# Generated by Django 2.2.1 on 2019-05-27 13:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activityType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='activityTypeNameFk', to='miscore.ActivityType')),
            ],
        ),
        migrations.CreateModel(
            name='Activity',
            fields=[
                ...
                ('activityType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='activityTypeFk', to='miscore.ActivityType')),
                ('activityTypeIdentifier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='activityTypeIdentifierNameFk', to='miscore.ActivityTypeIdentifier')),
